...
% VERSÃO SEM SUMÁRIO MANUAL (Pandoc gera automaticamente)
% ==================================================================
...
% ELEMENTOS TEXTUAIS
\input{sections/10_introducao_UPGRADE}
\input{sections/11_referencial_teorico_EXPANDIDO}
\input{sections/12_metodologia_UPGRADE}
\input{sections/13_resultados_NOVO_EMPIRICO}
\input{sections/14_discussao_NOVA_DESCOBERTA}
\input{sections/15_conclusao_NOVA_DESCOBERTA}

% REFERÊNCIAS
\input{sections/16_referencias}

% APÊNDICE
\input{sections/17_apendice}
