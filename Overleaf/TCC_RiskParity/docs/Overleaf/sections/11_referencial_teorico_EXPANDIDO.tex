...
\subsection{Condições de Superioridade do Peso Igual}
...
A estratégia Risk Parity surgiu da observação prática de que carteiras tradicionais, sejam cap-weighted ou otimizadas por Markowitz, frequentemente concentram risco em poucos ativos. Ray Dalio pioneirou esta abordagem nos anos 1990, observando que carteiras típicas institutional derivam 70-80% de seu risco de ações, apesar de diversificação nominal entre classes de ativos.
