...
\begin{itemize}
    \item \textbf{Performance absoluta:} Retorno anualizado de 26,1\% vs. 24,1\% (Equal Weight) e 19,0\% (Risk Parity)
    \item \textbf{Eficiência risco-retorno:} Sharpe Ratio de 1,90 vs. 1,49 e 1,26 das alternativas
    \item \textbf{Controle de risco de cauda:} Sortino Ratio de 2,51 vs. 1,65 e 10,97 respectivamente
    \item \textbf{Gestão de drawdown:} Perda máxima de -12,3\% vs. -19,7\% (Equal Weight) e -18,6\% (Risk Parity)
    \item \textbf{Menor volatilidade:} 14,5\% vs. 20,9\% (Equal Weight) e 17,2\% (Risk Parity)
\end{itemize}
...
\paragraph{Risk Parity:} Demonstrou excelente controle de risco de cauda com Sortino de 10,97, ocupando posição intermediária com volatilidade de 17,2\%. Embora tenha apresentado o menor retorno (19,0\%), manteve controle superior de perdas com Sharpe de 1,26.

\paragraph{Equal Weight:} Surpreendeu pela competitividade, alcançando o segundo maior retorno (24,1\%) com simplicidade operacional. Seu Índice de Sharpe (1,49) foi superior ao Risk Parity, validando a estratégia de diversificação ingênua em períodos de recuperação econômica.
