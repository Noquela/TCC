...
% Páginas iniciais não numeradas
...
% Inicia numeração romana para pré-textuais (a partir da 3ª página física)
\pagenumbering{roman}
\setcounter{page}{1}

% LISTA DE FIGURAS
\input{sections/03_lista_figuras}
\newpage

% LISTA DE TABELAS
\input{sections/04_lista_tabelas}
\newpage

% LISTA DE ABREVIATURAS E SIGLAS
\input{sections/05_lista_abreviaturas}
\newpage

% LISTA DE FÓRMULAS
\input{sections/06_lista_formulas}
\newpage

% RESUMO
\input{sections/07_resumo}
\newpage

% ABSTRACT
\input{sections/08_abstract}
\newpage
...
% ELEMENTOS TEXTUAIS
\input{sections/09_introducao}
\input{sections/10_referencial_teorico}
\input{sections/11_metodologia}

% REFERÊNCIAS
\input{sections/12_referencias}
